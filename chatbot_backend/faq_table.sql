...
('How do I start a project with you?', 'Schedule a call at https://calendly.com/official-wilkinjones/30min or email hello@leoconsult.org. We’ll scope goals and data access, then provide next steps.', 'onboarding,contact,cta', 'US', '2025-08-01'),
