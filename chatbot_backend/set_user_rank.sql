...
SELECT id, email FROM auth.users WHERE email = 'hello@leoconsult.org';
...
WHERE email = 'hello@leoconsult.org';

-- Verify it worked:
SELECT email, raw_user_meta_data FROM auth.users WHERE email = 'hello@leoconsult.org';
